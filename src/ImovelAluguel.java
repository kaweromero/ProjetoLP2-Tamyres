...
public class ImovelAluguel {
	...
	public void mostrarImovel() {
		...
		System.out.println("--- Informações do Imovel encontrado para alugar: " + "Proprietário :" + proprietario
				+ " / Tipo do Imovel: " + tipo + " / Area: " + area + " / Número de quartos: " + numQuartos
				+ " / Vagas da garagem " + garagem + " / Preço do aluguel: R$ " + preco);
