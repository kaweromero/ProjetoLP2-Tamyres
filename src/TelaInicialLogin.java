...
public class TelaInicialLogin {
       ...
       System.out.println(  ProjetoLp2.Dados.get("kawe").listaImoveis.get(0).tipo );
       
       }
}

/*  Dados = new HashMap<String, Conta>(1000);
         VendaDeImovelControle p = new VendaDeImovelControle();
         Usuario p = new Usuario(String, String);
